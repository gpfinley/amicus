...
import edu.umn.ensembles.exporters.AnnotationExporter;
    ...
    public void initialize(UimaContext context) throws ResourceInitializationException {
        ...
        try {
            if (alignerClassName != null) {
                ...
                aligner = Ensembles.DEFAULT_ALIGNER_CLASS_FOR_EXPORTER.newInstance();
            }
        ...
        try {
            if (exporterClass == null) {
                exporter = Ensembles.DEFAULT_EXPORTER_CLASS.newInstance();
            } else {
    ...
    private List<List<Annotation>> getAnnotations(JCas jCas) {
        ...
        for (int i=0; i< readViews.length; i++) {
            ...
            try {
                ...
                e.printStackTrace();
                throw new EnsemblesException("Couldn't view %s", readViews[i]);
            }
